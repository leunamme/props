    ...
    <header id="header-wrap">
          ...
          <div class="row">
            <div class="col-lg-7 col-md-9 col-xs-12">
              ...
              <ul class="links clearfix">
                ...
                <li><i class="lni-envelope"></i> <a href="http://preview.uideck.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6c05020a032c09140d011c0009420f0301">[email&#160;protected]</a></li>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white"  data-toggle="sticky-onscroll">
            ...
            <ul class="navbar-nav mr-auto w-100 justify-content-center">
              ...
              <li class="nav-item dropdown active">
                <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                 ...
                 <div class="dropdown-menu">
                  <a class="dropdown-item active" href="property.html">Default- Variation</a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item" href="blog-details.html">Blog Single Page</a>
                </div>
              </li>
              <li class="nav-item">
        ...
        <ul class="mobile-menu">
          ...
          <li>
            <a class="active" href="#">Property</a>
             <ul class="dropdown">
              <li><a class="active" href="property.html">Default- Variation</a></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
              ...
              <ul class="address">
                ...
                <li>
                  <a href="#"><i class="lni-envelope"></i> <span class="__cf_email__" data-cfemail="4f272a2323200f2a372e223f232a612c2022">[email&#160;protected]</span></a>
                </li>
              </ul>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
...
<!-- Mirrored from preview.uideck.com/items/brittville-demo/property.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Jun 2018 17:31:29 GMT -->
</html>
