          ...
          <div class="row">
            <div class="col-lg-7 col-md-9 col-xs-12">
              ...
              <ul class="links clearfix">
                ...
                <li><i class="lni-envelope"></i> <a href="http://preview.uideck.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a3cacdc5cce3c6dbc2ced3cfc68dc0ccce">[email&#160;protected]</a></li>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white"  data-toggle="sticky-onscroll">
          ...
          <div class="collapse navbar-collapse" id="main-navbar">
            <ul class="navbar-nav mr-auto w-100 justify-content-center">
              ...
              <li class="nav-item dropdown active">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item active" href="listing.html">Simple Listing</a>
        ...
        <ul class="mobile-menu">
          ...
          <li>
            ...
            <ul class="dropdown">
              <li><a class="active" href="listing.html">Simple Listing</a></li>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
              ...
              <ul class="address">
                ...
                <li>
                  <a href="#"><i class="lni-envelope"></i> <span class="__cf_email__" data-cfemail="7c14191010133c19041d110c1019521f1311">[email&#160;protected]</span></a>
                </li>
              </ul>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
